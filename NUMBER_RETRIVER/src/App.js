...
import SortedIntegersDisplay from './componet/SortedIntegersDisplay'; 
// import './number.css';
...
function App() {
  ...
  return (
    <div className="app">
      <h1 className='heading'>NUMBER RETRIVER FROM URL</h1>
      <form onSubmit={handleSubmit}>
        ...
        <button className='button' type="submit">Fetch and Sort Integers</button>
      </form>
